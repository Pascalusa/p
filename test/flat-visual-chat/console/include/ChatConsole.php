...
class ChatConsole
{
    ...
    private function checkInstallation()
    {
            ...
            `bounceFx` tinyint(1) NOT NULL,
            `purchaseCode` varchar(250) NOT NULL,
            `updated` tinyint(1) NOT NULL,
            `playSound` tinyint(1) NOT NULL,
            `url` varchar(250) NOT NULL,
            `chatPosition` varchar(8) NOT NULL,
            `sendLogs` tinyint(1) NOT NULL,
            `emailLogSubject` varchar(250) NOT NULL,
            `enableInitiate` tinyint(1) NOT NULL,
	     UNIQUE KEY id (id)
